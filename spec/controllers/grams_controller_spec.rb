...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    ...
    it "shouldn't let a user who did not create the gram to destroy the gram" do
    ...
    it "should return a 404 message if we cannot find a gram with the id specified" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    ...
    it "shouldn't let user who did not create the gram to update the gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
    ...
    it "should return a 404 error if the gram cannot be found" do
      user = FactoryBot.create(:user)
      sign_in user
      patch :update, params: { id: 'YOLOSAWAG', gram: {message: 'Changed'}}
      expect(response).to have_http_status(:not_found)
    end
  ...
  describe "grams#edit action" do
    ...
    it "should successfully show the edit form if the grams is found" do
      gram = FactoryBot.create(:gram)
      sign_in gram.user
      get :edit, params: { id: gram.id}
  ...
  describe "grams#create action " do
    ...
    it "should redirect_to users to be logged in" do
